...
- **精準解碼引擎**：支援九九藏書的新版解密邏輯，自動還原打亂的段落並清理干擾標籤。
- **完整中繼資料**：自動抓取書名、作者與類別，並封裝至 EPUB Metadata。
- **即時回饋**：使用 `Rich` 庫提供下載進度條與終端回饋。
- **安全性**：內建輸入驗證與檔名安全過濾，防止路徑遍歷攻擊。
...
- [zsakvo](https://github.com/zsakvo) - 原始 Node.js 版本作者
- [Gemini](https://gemini.google.com/) - AI 輔助重構與開發
